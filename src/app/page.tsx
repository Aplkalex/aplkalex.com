                            ...
                            <motion.div variants={fadeInUp} className="flex flex-wrap gap-4">
                                ...
                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                    <motion.button
                                        ...
                                        className="px-8 py-3 bg-white/5 border border-white/10 text-white rounded-full font-semibold hover:bg-white/10 transition-colors flex items-center justify-center gap-2 relative z-10 cursor-pointer"
                                    >
                            ...
                            <motion.div variants={popIn} className="h-full">
                                <div onClick={handleQueuesisClick} className="block h-full group cursor-pointer">
                                    <motion.div layoutId="queuesis-card" className="h-full">
                                        <GlassCard className="h-full flex flex-col relative overflow-hidden transition-transform duration-300 group-hover:scale-[1.02] group-hover:border-white/20 bg-[#111] backdrop-blur-xl">
                                            {/* Content Overlay */}
