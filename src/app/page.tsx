                        ...
                        >
                            ...
                            <motion.div variants={fadeInUp} className="flex flex-wrap gap-4">
                                ...
                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                    <Link
                                        href="#contact"
                                        className="px-8 py-3 bg-gray-100 border border-gray-300 text-gray-800 rounded-full font-semibold shadow-md hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:border-white/20 dark:hover:bg-white/20 dark:hover:text-white transition-colors flex items-center justify-center"
                                    >
                                        Contact Me
                                    </Link>
                                </motion.div>
                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                    <motion.button
                                        ...
                                        className="px-8 py-3 bg-gray-100 border border-gray-300 text-gray-800 rounded-full font-semibold shadow-md hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:border-white/20 dark:hover:bg-white/20 dark:hover:text-white transition-colors flex items-center justify-center gap-2 relative z-10 cursor-pointer"
                                    >
